protected class AreaButtonPanel extends GeneralPanel {
  private Area area;
  protected AreaButtonPanel(Area area,float x,float y,float sizeX,float sizeY,color background,float padding, float curve,color lineColor,float lineSize) {
  ...
  private void stats(float mx,float my) {
    textAlign(TOP,TOP);
    fill(255);
    textSize(13);
