public class CharacterPanel extends GeneralPanel{
  ...
  public CharacterPanel(float x,float y,float sizeX,float sizeY,color background,float padding, float curve,color lineColor,float lineSize,CharacterConfigurePanel cCP,long Level) {
