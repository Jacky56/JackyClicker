...
void setup() {
  ...
  areaDungeon.add(new AreaDungeon("The Farm","Just about right.",color(200),aPlayer,player123,loadImage("BackgroundImage/Farm.jpg"),1000,0,color(204,255,255),1,1,1,1,1,3,1,1,0,1.02,0.5));
  
  areaDungeon.add(new AreaDungeon("The Forest","Beware of the deep hole...",color(200),aPlayer,player123,loadImage("BackgroundImage/Forest.jpg"),50,0,color(0,102,51),3,2,3,3,4,2.1,1.8,2.5,0,1.1,0.35));
  ...
  areaDungeon.add(new AreaDungeon("Cookie Realm","http:// orteil.dashnet.org/ cookieclicker/",color(200),aPlayer,player123,loadImage("BackgroundImage/CookieClickerBG.jpg"),50000,0,color(25,25,200),0,0,50,0,0,0,0.1,0.1,0,1.001,0.00));
  ...
  areaDungeon.add(new AreaDungeon("GoldSmiths","Easter egg: Ilyap Hillips",color(200),aPlayer,player123,loadImage("BackgroundImage/GoldSmiths.jpg"),10,0,color(204,204,0),100,0,0,0,0,7.5,0,0,0,10,0));
