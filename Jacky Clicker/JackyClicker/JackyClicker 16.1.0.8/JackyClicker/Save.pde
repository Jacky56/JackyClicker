...
void Load() {
  ...
  if(new File(dataPath("Save\\SaveAreaDungeon.json")).exists()) {
    ...
    areaDungeon.add(new AreaDungeon("Elder Pact","'Squirm crawl slither writhe today we rise.'",color(200),"BackgroundImage/Grandma.jpg",10000,0,color(200,25,25),0.7,0.6,0.4,1,1,0.5,0.5,0.45,0,1.002,0.02));
    ...
    areaDungeon.add(new AreaDungeon("GoldSmiths","Easter egg: Ilya Phillips",color(200),"BackgroundImage/GoldSmiths.jpg",10,0,color(204,204,0),100,0,0,0,0,7.5,0,0,0,10,0));    
  }
}