public class Unit extends Object {
  ...
  public void CharStatToCharAdv() {
    ...
    CharRegHp = ConvertStatToAdv(CharVit,CharStr,CharEnd,CharAgi,CharDex,0.05,0,0,0,0);
  ...
  public void statBonusStatToBonusAdv() {
    ...
    statBonusRegHp = ConvertStatToAdv(BonusVit,BonusStr,BonusEnd,BonusAgi,BonusDex,0.05,0,0,0,0);
  ...
  public void ItemStatToBonusAdv() {
    ...
    ItemDef = ConvertStatToAdv(ItemVit,ItemStr,ItemEnd,ItemAgi,ItemDex,0,0,0.5,0,0);
    ItemRegHp = ConvertStatToAdv(ItemVit,ItemStr,ItemEnd,ItemAgi,ItemDex,0.05,0,0,0,0);
