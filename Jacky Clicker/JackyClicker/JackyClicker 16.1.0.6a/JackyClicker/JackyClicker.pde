...
void setup() {
  ...
  player123.PlayerLevelUp(1000000000000000l);
  player123.Zeny = 1000000343l;
...
void draw() {
  ...
  for(int n = 0; n < player123.LvlUp.size(); n++) {
    player123.LvlUp.get(n).draw();
  }
