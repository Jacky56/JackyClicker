...
protected class AreaDungeon extends Area {
  ...
  @Expose
  private boolean BossMileStone; //test if user is at a mile stone
  @Expose
  private boolean ReachedBoss; //will spawn a boss model enemy 
  @Expose
  private boolean BossSpawned; //to check if the boss exist 
  @Expose
  private boolean DungeonLordSpawn; //realmlord* its the last boss of the realm
  //important
  @Expose
  public boolean DungeonLordKilled; // check if the realm lord was killed
