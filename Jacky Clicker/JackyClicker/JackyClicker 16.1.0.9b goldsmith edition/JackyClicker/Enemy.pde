          ...
          if(random(100) < 2) {
            ...
            for(int i = 0; i < pla.Inventory.length; i++) {
              if(pla.Inventory[i] == null) {
                ...
                pla.Inventory[i] = new Equipment(random(1,100),CurrentMile,Dif,inventoryPanel.x +inventoryPanel.padding + inventoryPanel.SlotOrder*(i%3),inventoryPanel.y + inventoryPanel.sizeY - 20 - (inventoryPanel.SlotOrder * 4) - inventoryPanel.padding + inventoryPanel.SlotOrder*floor(i/3),inventoryPanel.SlotOrder-4,inventoryPanel.SlotOrder-4);
