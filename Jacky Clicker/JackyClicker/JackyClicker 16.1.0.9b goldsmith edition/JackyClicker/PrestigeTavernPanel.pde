protected class PrestigeTavernPanel extends GeneralPanel {
  
  private Button PrestigeButton;
  
  private Button Close;

  private HoverInfo hoverLevel;
  
  protected PrestigeTavernPanel(float x,float y,float sizeX,float sizeY,color background,float padding, float curve,color lineColor,float lineSize) {
