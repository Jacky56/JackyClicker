protected class RecruitPanel extends GeneralPanel {
  
  private Button RecruitConfigureButton;
  private Button OverTimeButton;
  
  
  private RecruitConfigurePanel RCP;
  
  
  
  private HoverInfo RecruitInfo;
  
  
  
  protected RecruitPanel(float x,float y,float sizeX,float sizeY,color background,float padding, float curve,color lineColor,float lineSize,RecruitConfigurePanel RCP) {
  ...
  protected void ActionEvent(Player pl,Enemy en) {
    if(show) {
