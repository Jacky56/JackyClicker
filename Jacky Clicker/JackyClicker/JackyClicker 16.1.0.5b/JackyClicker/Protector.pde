public class Protector extends GuildUnit {
  ...
  public Protector(Player pl,float uVit,float uStr,float uEnd,float uAgi,float uDex,long exp)  {
    ...
    Name = "Protector";
    Description = "Blocks 45% enemy damage for you, Cost 2 Mood. (Must be above Moody, Auto)";
  ...
  @Override
  public void TriggerEvent(Enemy en) {
    Defend(en);
  }
  
  public void Defend(Enemy en) {
    if(en.TempDmg > 0 && Moody == false && Strike == false) {
