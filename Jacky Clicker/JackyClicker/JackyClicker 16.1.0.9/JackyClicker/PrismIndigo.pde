protected class PrismIndigo extends GuildUnit {
  
  protected PrismIndigo(float uVit,float uStr,float uEnd,float uAgi,float uDex,long exp)  {
  ...
  protected PrismIndigo(GuildUnit gu) {
