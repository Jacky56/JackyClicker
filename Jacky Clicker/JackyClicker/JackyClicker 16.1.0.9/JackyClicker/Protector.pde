protected class Protector extends GuildUnit {
  
  protected Protector(float uVit,float uStr,float uEnd,float uAgi,float uDex,long exp)  {
  ...
  protected Protector(GuildUnit gu) {
