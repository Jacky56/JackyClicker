public class Priest extends GuildUnit {
  ...
  public void TimeEvent() {
    super.TimeEvent();
    UnitAsButton.hoverInfo.updateDescription(Name,"Grants a Buff which increases regen by " + ceil(Level*0.1) + " and defence by " + ceil(Level*0.25) +" for 5 mins. Cost 15 Mood. " + Description);
  }
