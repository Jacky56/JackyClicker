...
public class CharacterConfigurePanel extends GeneralPanel {
  ...
  public CharacterConfigurePanel(Player pl, float x,float y,float sizeX,float sizeY,color background,float padding, float curve,color lineColor,float lineSize) {
  ...
  //..
  void ApplyStat(int n,int amount) {
