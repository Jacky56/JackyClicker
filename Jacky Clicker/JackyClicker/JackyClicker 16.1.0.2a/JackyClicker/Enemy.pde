public class Enemy extends Unit {
  ...
  public Enemy(String Name,String Description,float x,float y,long CharVit,long CharStr,long CharEnd,long CharAgi,long CharDex,int AttackTimer,long ExpBounty,long GoldBounty) {
