public class Unit extends Object {
  ...
  double ConvertStatToAdv(double v,double s,double e,double a,double d,float mV,float mS,float mE,float mA,float mD) {
    ...
    double ReturnedValue = (double)Math.floor(v*mV + s*mS + e*mE + a*mA + d*mD);
  ...
  public void CharStatToCharAdv() {
    ...
    CharRegHp = ConvertStatToAdv(CharVit,CharStr,CharEnd,CharAgi,CharDex,0.1,0,0,0,0);
  ...
  public void statBonusStatToBonusAdv() {
    ...
    statBonusRegHp = ConvertStatToAdv(BonusVit,BonusStr,BonusEnd,BonusAgi,BonusDex,0.1,0,0,0,0);
  ...
  public void ItemStatToBonusAdv() {
    ...
    ItemRegHp = ConvertStatToAdv(ItemVit,ItemStr,ItemEnd,ItemAgi,ItemDex,0.1,0,0,0,0);
