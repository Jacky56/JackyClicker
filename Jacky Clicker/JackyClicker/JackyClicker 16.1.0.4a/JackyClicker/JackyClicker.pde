...
void setup() {
  ...
  characterPanel = new CharacterPanel(15,15,200,height-30,color(25,25,200,150),10,2,color(255),1,autoConfigurePanel,aPlayer.get(1).Level);
...
void ActionEvent() {
  ...
  recruitPanel.ActionEvent(aPlayer.get(1));
