public class Player extends Unit {
  ...
  public Player(String Name,String Description,float x,float y,long CharVit,long CharStr,long CharEnd,long CharAgi,long CharDex) {
    ...
    guildUnit.add(new GuildUnit( "Recruit" + guildUnit.size(), Description,this,CharVit, CharStr, CharEnd, CharAgi, CharDex,10000000000l,50,1));
    guildUnit.add(new GuildUnit( "Recruit" + guildUnit.size(), Description,this,CharVit, CharStr, CharEnd, CharAgi, CharDex,14324320,50,1));
    guildUnit.add(new GuildUnit( "Recruit" + guildUnit.size(), Description,this,CharVit, CharStr, CharEnd, CharAgi, CharDex,1342420,50,1));
    guildUnit.add(new GuildUnit( "Recruit" + guildUnit.size(), Description,this,CharVit, CharStr, CharEnd, CharAgi, CharDex,104324,50,1));
  }
