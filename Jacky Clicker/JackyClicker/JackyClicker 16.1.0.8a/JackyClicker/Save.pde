...
void Load() {
  ...
  if(new File(dataPath("Save\\SaveAreaDungeon.json")).exists()) {
    ...
    areaDungeon.add(new AreaDungeon("The Forest","Most stable environment.",color(200),"BackgroundImage/Forest.jpg",800,0,color(0,102,51),1,1,1,1,1,3,1,1,0,1.01,0.5));
    for(int n = 0; n < 3; n++) {
